...
/* Windows Event Logging API has been changed to Windows Event Log since 
   WIndows Vista, need to define Windows version to compile for Windows Vista
...
/* Define to 1 if you have the `wbemuuid' library (-lwbemuuid). */
/* #undef HAVE_LIBWBEMUUID */
